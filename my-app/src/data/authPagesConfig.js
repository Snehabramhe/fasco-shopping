...
export const AUTH_PAGES = {
  signin: {
    ...
    bottomRightLink: { text: "Forget Password?", to: "/auth/forgot" },
  ...
  signup: {
    ...
    bottomCenterLink: { text: "Already have an account? ", linkText: "Login", to: "/auth/signin" },
  },
  ...
  confirm: {
    ...
    secondaryButton: null,
    bottomRightLink: null,
    bottomCenterLink: { text: "Didn't receive Confirmation Code? ", linkText: "Resend Now", to: "/auth/confirm" },
  },
  ...
  reset: {
    ...
    fields: [
      ...
      // ✅ IMPORTANT: use same name in schema
